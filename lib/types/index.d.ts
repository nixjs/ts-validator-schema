 ...
 */
export type BaseMessage = 'default_required' | 'required' | 'required_min' | 'required_max' | 'length_invalid' | 'domain_invalid' | 'phone_invalid' | 'date_invalid' | 'url_invalid' | 'regex_invalid' | 'email_invalid' | 'non_nullable' | 'non_undefined';
 ...
 */
export declare const flattenSchemaValueWith: <K extends string, M extends string>(schema: Define<K, M>, key: K, allowPrefixKey?: boolean) => Record<string, M> | null;
/**
 ...
 */
export declare const flattenSchemaValue: <K extends string, M extends string>(schema: Define<K, M>, prefix?: string) => Record<string, M>;
/**
 ...
 */
export declare const flattenSchemaKey: (key: string, message: string, prefix?: string) => string;
/**
 ...
 */
export declare const isDefaultRequiredMessage: (message: string) => boolean;
